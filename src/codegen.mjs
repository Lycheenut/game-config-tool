...
function generatedHeaderLines() {
    return [
        '/* eslint-disable */',
        '// This file is generated by @lycheenut/game-config-tool. Do not edit by hand.',
        ''
    ];
}
...
function ensureRequiredFields(fields) {
    ...
    if (!keys.has('name')) {
        missingFields.push({ key: 'name', type: 'string', description: '鏄剧ず鍚嶇О' });
    }
...
function normalizeRequiredField(field) {
    ...
    if (field.key === 'name') {
        return { key: field.key, type: 'string', description: '鏄剧ず鍚嶇О' };
    }
    return field;
}
